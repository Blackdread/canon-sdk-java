...
public class tagEdsPictureStyleDesc extends Structure {
	 ...
	 */
	public tagEdsPictureStyleDesc(NativeLong contrast, NativeLong sharpness, NativeLong saturation, NativeLong colorTone, NativeLong filterEffect, NativeLong toningEffect, NativeLong sharpFineness, NativeLong sharpThreshold) {
		super();
